...
model1_df$Coefficient <- as.character(model1_df$Coefficient)
...
model2_df$Coefficient <- as.character(model2_df$Coefficient)
...
model3_df$'Odds ratio' <- as.character(model3_df$'Odds ratio')
...
model4_df$'Odds ratio' <- as.character(model4_df$'Odds ratio')
...
model5_df$'Odds ratio' <- as.character(model5_df$'Odds ratio')
...
#gt tables linear models
```{r}
replace_dots <- function(x) {
  gsub("\\.", "·", x)
}

model1_compl[] <- lapply(model1_compl, function(x) if(is.character(x)) replace_dots(x) else x)

model2_compl[] <- lapply(model2_compl, function(x) if(is.character(x)) replace_dots(x) else x)

model3_compl[] <- lapply(model3_compl, function(x) if(is.character(x)) replace_dots(x) else x)

model4_compl[] <- lapply(model4_compl, function(x) if(is.character(x)) replace_dots(x) else x)

model5_compl[] <- lapply(model5_compl, function(x) if(is.character(x)) replace_dots(x) else x)

clin_score_lm <- gt(model1_compl, rownames_to_stub = F) %>%
  tab_header(title = "N° of organ systems involved") %>%
...
table_wave_a[] <- lapply(table_wave_a, function(x) if(is.character(x)) replace_dots(x) else x)

table_wave_b[] <- lapply(table_wave_b, function(x) if(is.character(x)) replace_dots(x) else x)

table_age_a[] <- lapply(table_age_a, function(x) if(is.character(x)) replace_dots(x) else x)

table_age_b[] <- lapply(table_age_b, function(x) if(is.character(x)) replace_dots(x) else x)
```
...
#word tables
```{r}
table_wave_a <- cbind(RowName = rownames(table_wave_a), table_wave_a)
table_wave_a_flextable <- flextable(table_wave_a)
table_wave_a_doc <- read_docx()
table_wave_a_doc <- body_add_flextable(table_wave_a_doc, table_wave_a_flextable)
print(table_wave_a_doc, target = "Results/table_wave_a.docx")

table_wave_b <- cbind(RowName = rownames(table_wave_b), table_wave_b)
table_wave_b_flextable <- flextable(table_wave_b)
table_wave_b_doc <- read_docx()
table_wave_b_doc <- body_add_flextable(table_wave_b_doc, table_wave_b_flextable)
print(table_wave_b_doc, target = "Results/table_wave_b.docx")

table_age_a <- cbind(RowName = rownames(table_age_a), table_age_a)
table_age_a_flextable <- flextable(table_age_a)
table_age_a_doc <- read_docx()
table_age_a_doc <- body_add_flextable(table_age_a_doc, table_age_a_flextable)
print(table_age_a_doc, target = "Results/table_age_a.docx")

table_age_b <- cbind(RowName = rownames(table_age_b), table_age_b)
table_age_b_flextable <- flextable(table_age_b)
table_age_b_doc <- read_docx()
table_age_b_doc <- body_add_flextable(table_age_b_doc, table_age_b_flextable)
print(table_age_b_doc, target = "Results/table_age_b.docx")
```
...
y_labels <- c('N° of organ systems', 'Days', 'mg/l')
...
y_label.nlog <- c('N° of organ systems', 'Days', 'mg/l')
